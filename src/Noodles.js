...
const material = new LayerMaterial({
  layers: [
    ...
    new Depth({ colorA: 'orange', colorB: 'black', alpha: 0.5, mode: 'add', near: 3, far: 2, origin: [1, 1, 1] }),
    new Fresnel({ mode: 'add', color: fresnel, intensity: 0.5, power: 2.5, bias: 0.0 }),
...
function Noodle() {
  ...
  const [speed] = useState(() => 1 + Math.random() / 10)
